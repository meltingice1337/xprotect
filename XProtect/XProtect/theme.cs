...
namespace MonoFlat
{
    ...
    public class MonoFlat_GroupBox : GroupBox
    {
        public MonoFlat_GroupBox()
        {
        }
    ...
    [DefaultEvent("CheckedChanged")]
    public class MonoFlat_RadioButton : RadioButton
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if(Enabled)
                ...
                G.DrawString(Text, Font, new SolidBrush(Color.FromArgb(94, 94, 94)), new Point(20, 0));
        }
    }
    ...
    public class MonoFlat_ListBox : ListBox
    {

        private GraphicsPath Shape;
        public MonoFlat_ListBox()
        {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(Pens.Black, 1000, 0, 0, 1000);
        }
    ...
    public class MonoFlat_Separator : Control
    {
        ...
        private Types _Orientation = Types.Horizontal;
        public Types Orientation
        {
            get
            {
                return _Orientation;
        ...
        {
            base.OnPaint(e);
            if(_Orientation == Types.Horizontal)
                e.Graphics.DrawLine(new Pen(Color.FromArgb(45, 57, 68), 1), 0, 5, Width, 5);
            else
                e.Graphics.DrawLine(new Pen(Color.FromArgb(45, 57, 68), 1), 0, 5, 0, Height);
